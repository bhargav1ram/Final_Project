...
public class Constants {
    ...
    public final double feePercent = 0.2; // percentage of transaction charged as fee
    ...
    public final double minTradingsBalance = 1000; // minimum balance for trandings account
    public final double minTradingsAccountOpenBalance = minTradingsBalance/(1.0-feePercent); // minmum balance with which tradings account can be opened
